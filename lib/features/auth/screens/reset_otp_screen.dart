  ...
  Future<void> _verifyAndProceed(PhoneAuthCredential credential) async {
    ...
    try {
      ...
      context.pushReplacement(
        '/new-password?phone=${Uri.encodeComponent(widget.phone)}&token=${Uri.encodeComponent(idToken)}',
      );
    } catch (e) {
            ...
            children: [
              ...
              Text(
                ...
                style: GoogleFonts.manrope(
                    fontSize: 14, color: TwamboColors.textSecondary),
              ),
              ...
              if (_sending)
                ...
                TextFormField(
                  ...
                  style: GoogleFonts.spaceGrotesk(
                      ...
                      letterSpacing: 12, color: TwamboColors.textPrimary),
